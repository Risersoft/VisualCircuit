...
namespace Syncfusion.Windows.Forms.Diagram.Samples.DiagramTool
{
  ...
  public Controls.Diagram ActiveDiagram
        {
            get
            {
   ...
   public SymbolPalette PreparePaletteToSave()
        {
        ...
        private void groupBar_NodeClick(object sender, EventArgs evtArgs)
        {
                ...
                (this.NodeToDiagramMap[node] != null && (this.NodeToDiagramMap[node] as Form).Parent == null)))
            {
                ...
                if (mdlTmp != null)
                {
                    ...
                    mdlTmp.Size = new SizeF(
                        mdlTmp.Size.Width + bounds.Size.Width / 2,
                        mdlTmp.Size.Height + bounds.Size.Height / 2
                        );
                    ...
                    foreach (Node n in mdlTmp.Nodes)
                    {
                        ...
                        bool allowmove = n.EditStyle.AllowMove;
                        n.EditStyle.AllowMove = false;


                        float fx = MeasureUnitsConverter.Convert((mdlTmp.Size.Width - bounds.Size.Width) / 2, MeasureUnits.Pixel, n.MeasurementUnit);
                        float fy = MeasureUnitsConverter.Convert((mdlTmp.Size.Height - bounds.Size.Height) / 2, MeasureUnits.Pixel, n.MeasurementUnit);

                        n.Translate(fx, fy);

                        n.EditStyle.AllowMove = allowmove;
